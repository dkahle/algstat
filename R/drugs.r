...
#' 
#' A multi-way contingency table of alcohol, cigarettes, and
...
#' @author Wright State University School of Medicine and the United
#'   Health Services in Dayton, Ohio
#' @references Agresti, A. (2002). \emph{Categorical Data Analysis},
#'   Basel: John Wiley & Sons, 2ed. (p.322)
NULL