...
#'
#' In a ranking of m objects, the Condorcet choice is the choice that wins over
#' every other choice in pairwise comparisons.  See Marden (1995), p.20 for
#' details.
#'
#' @param data the data, a vector of counts of each permutation of the m objects
