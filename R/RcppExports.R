...
metropolis_hypergeometric_cpp <- function(current, moves, iter, thin) {
    .Call('_algstat_metropolis_hypergeometric_cpp', PACKAGE = 'algstat', current, moves, iter, thin)
}

metropolis_uniform_cpp <- function(current, moves, iter, thin) {
    .Call('_algstat_metropolis_uniform_cpp', PACKAGE = 'algstat', current, moves, iter, thin)
}
