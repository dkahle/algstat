...
(samps <- rvnorm(500, p, .025, "tibble", w = 2, chains = 8))
# # A tibble: 4,000 x 8
#         x      y         num denom          ng  lp__ chain  iter
#     <dbl>  <dbl>       <dbl> <dbl>       <dbl> <dbl> <int> <int>
#  1 1.17    0.614  0.0874     3.31   0.0264      1.70     1   251
#  2 1.08    0.157  0.00287    0.244  0.0118      2.31     1   252
#  3 1.11    0.316  0.0000211  0.716  0.0000295   2.37     1   253
#  4 0.674  -0.427 -0.0126     0.868 -0.0145      2.43     1   254
#  5 0.0903 -0.920  0.00327    0.205  0.0159      2.33     1   255
#  6 0.200  -0.841  0.00783    0.514  0.0152      2.38     1   256
#  7 0.109  -0.870 -0.00449    0.353 -0.0127      2.43     1   257
#  8 0.461  -0.651  0.0102     1.00   0.0102      2.52     1   258
#  9 0.176  -0.840 -0.00000477 0.502 -0.00000952  2.57     1   259
# 10 0.0918 -0.875 -0.00599    0.326 -0.0184      2.29     1   260
